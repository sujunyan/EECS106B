...
if("FALSE" STREQUAL "TRUE")
  set(baxter_sim_io_SOURCE_PREFIX /scratch/shared/baxter_ws/src/baxter_simulator/baxter_sim_io)
  set(baxter_sim_io_DEVEL_PREFIX /scratch/shared/baxter_ws/devel)
  ...
  set(baxter_sim_io_INSTALL_PREFIX /scratch/shared/baxter_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_sim_io' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/scratch/shared/baxter_ws/install/${idir}'.  ${_report}")
    endif()
