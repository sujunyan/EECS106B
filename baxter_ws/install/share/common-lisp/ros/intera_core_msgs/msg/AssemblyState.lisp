...
(cl:defmethod cl:initialize-instance :after ((m <AssemblyState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AssemblyState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name intera_core_msgs-msg:<AssemblyState> is deprecated: use intera_core_msgs-msg:AssemblyState instead.")))
...
(cl:defmethod lowVoltage-val ((m <AssemblyState>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AssemblyState>)))
  ...
  "1dd1da5d897074cd1eece6cc0449a2eb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AssemblyState)))
  "Returns md5sum for a message object of type 'AssemblyState"
  "1dd1da5d897074cd1eece6cc0449a2eb")
