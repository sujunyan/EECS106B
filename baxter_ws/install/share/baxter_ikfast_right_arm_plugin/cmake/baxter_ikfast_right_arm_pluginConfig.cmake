...
if("FALSE" STREQUAL "TRUE")
  set(baxter_ikfast_right_arm_plugin_SOURCE_PREFIX /scratch/shared/baxter_ws/src/moveit_robots/baxter/baxter_ikfast_right_arm_plugin)
  set(baxter_ikfast_right_arm_plugin_DEVEL_PREFIX /scratch/shared/baxter_ws/devel)
  ...
  set(baxter_ikfast_right_arm_plugin_INSTALL_PREFIX /scratch/shared/baxter_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_ikfast_right_arm_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/scratch/shared/baxter_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /scratch/shared/baxter_ws/install/lib;/opt/ros/kinetic/lib)
